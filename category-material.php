...
$query = "SELECT DISTINCT brand, id, name, price, image, motasanpham FROM products WHERE brand = 'nguyenlieu'";
if (!empty($category)) {
    $query .= " AND category = '$category'";
}
$result = mysqli_query($con, $query);
if (!$result) {
    die("Lỗi truy vấn: " . mysqli_error($con) . "<br>Câu truy vấn: " . $query);
}
?>
